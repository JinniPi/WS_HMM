...
if __name__ == '__main__':
    ...
    content = 'Đây là nội dung thử nghiệm. Cho đến cuối ngày 8-9 cũng chỉ mới có sáu căn đã hoàn tất việc tháo dỡ 2.5% (Tuổi Trẻ ngày 3-9) .'\
            ' Hôm qua trời nắng nhưng hôm nay trời rất âm u'.lower()
    article = Article(content, 1, syllables_dictionary)
    print content.split('\n')
    # print article.detect_paragraph()
    # print article.paragraphs[0][1]
    ...
    # print article.convert_syllable_to_number()
